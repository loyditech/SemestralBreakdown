...
public class Player {
    ...
    public static final int STUDY_LIMIT = 5, WORK_LIMIT = 3, HANGOUT_LIMIT = 4, REST_LIMIT = 7;
    ...
    public void showWeeklyProgress() {
        System.out.printf("Weekly: Study %d/%d, Work %d/%d, Hangout %d/%d, Rest %d/%d\n",
            studyCount, STUDY_LIMIT, workCount, WORK_LIMIT, hangoutCount, HANGOUT_LIMIT, restCount, REST_LIMIT);
    }
}
